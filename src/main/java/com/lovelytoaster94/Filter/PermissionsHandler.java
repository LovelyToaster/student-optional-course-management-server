...
public class PermissionsHandler implements HandlerInterceptor {
    private static final List<String> unnecessaryPermissionsPath = Arrays.asList("/teacher/all", "/teacher/search", "/course/all", "/course/search", "/user/login", "/user/status", "/user/loginOut", "/user/getAvatar", "/user/emailSend", "/user/forgetPassword", "/courseTask/all");
